      ...
      <nav className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 sticky top-0 z-40 px-3 md:px-6 py-2.5 transition-colors">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-3 md:gap-6 min-w-0">
            <Link to="/" className="flex items-center gap-1.5 font-black text-lg md:text-xl tracking-tight shrink-0">
              <span className="text-xl">🤖</span>
              <span className="bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent">
                BTSBots
              </span>
              <span className="text-[10px] px-1.5 py-0.5 rounded bg-blue-500/10 text-blue-500 font-mono font-bold uppercase">
                {appType}
              </span>
            </Link>
          ...
          {/* 右侧控制区 */}
          <div className="flex items-center gap-1.5 md:gap-2 shrink-0" ref={menuRef}>
            {/* 连接灯 */}
            <span
            ...
            <div className="relative">
              <button
                ...
                className="px-2.5 py-1.5 rounded-xl bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition text-xs font-bold text-gray-800 dark:text-gray-200 flex items-center gap-1 cursor-pointer border border-gray-200 dark:border-gray-700"
              >
                👤 <span className="font-mono max-w-[65px] sm:max-w-[110px] truncate">{isLoggedIn ? currentAccount : t.login}</span>
                ...
                <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-2xl py-1.5 z-50 text-xs animate-fade-in divide-y divide-gray-100 dark:divide-gray-700/50">
                  ...
                  {isLoggedIn && onOpenScan && (
                    <button
                      ...
                      className="w-full text-left px-3.5 py-2 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-500/10 font-bold transition flex items-center gap-2 cursor-pointer"
                    >
                      📷 {t.scan}
                    </button>
                  )}
                  ...
                  {isLoggedIn && (
                    <Link
                      ...
                      className="block px-3.5 py-2 text-gray-800 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700/50 font-bold transition"
                    >
                      ⚙️ {t.settings}
                    </Link>
                  )}
                  ...
                  <button
                    ...
                    className="w-full text-left px-3.5 py-2 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-500/10 font-bold transition cursor-pointer"
                  >
                    📚 {t.docs}
                  </button>
                  ...
                  <div className="flex justify-between items-center px-3.5 py-2 text-gray-800 dark:text-gray-200">
                    ...
                    <select
                      ...
                      className="bg-gray-100 dark:bg-gray-700 rounded-lg px-2 py-0.5 outline-none text-xs text-gray-800 dark:text-gray-200 font-bold"
                    >
                  ...
                  <div className="flex justify-between items-center px-3.5 py-2 text-gray-800 dark:text-gray-200">
                    ...
                    <button
                      ...
                      className="bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 px-2 py-0.5 rounded cursor-pointer text-xs font-bold"
                    >
                      切换
                    </button>
                  </div>
                  ...
                  <div className="pt-1">
                    {isLoggedIn ? (
                      <button
                        ...
                        className="w-full text-left px-3.5 py-2 text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 font-bold transition cursor-pointer"
                      >
                        🚪 {t.logout}
                      </button>
                    ) : (
                      <Link
                        ...
                        onClick={() => setMenuOpen(false)}
                        className="block px-3.5 py-2 text-blue-500 font-bold hover:bg-blue-50 dark:hover:bg-blue-500/10"
                      >
                        🔑 {t.login}
                      </Link>
                    )}
